    ...
    <div className="p-4 sm:px-6 lg:px-20 bg-[#fef4ec] min-h-screen">
      ...
      <div className="mb-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600">Manage your IoT vending operations</p>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-10">
        <div className="bg-white rounded-xl p-4 shadow-sm border-l-4 border-blue-500">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-600 font-semibold">Total Hosts</p>
            <MdOutlinePeopleOutline className="text-xl text-blue-500" />
          </div>
          <h2 className="text-2xl font-bold text-black">1,247</h2>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border-l-4 border-orange-500">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-600 font-semibold">Machines Online</p>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border-l-4 border-purple-500">
          ...
          <h2 className="text-2xl font-bold text-black">₹125,000</h2>
          <p className="text-sm text-gray-500">+12% from yesterday</p>
        </div>

        <div className="bg-white rounded-xl p-4 shadow-sm border-l-4 border-indigo-500">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-600 font-semibold">Total Envelopes</p>
            <FiCreditCard className="text-xl text-indigo-500" />
          </div>
          <h2 className="text-2xl font-bold text-black">3,420</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl p-6 shadow-md">
          <h3 className="text-xl font-semibold mb-2">Service Fee Structure</h3>
          <p className="text-2xl font-bold text-green-600">5% + ₹2,000</p>
          <p className="text-gray-500 mt-1">
            5% of budget amount + fixed service fee
          </p>
        </div>
        <div className="bg-white rounded-xl p-6 shadow-md">
          <h3 className="text-xl font-semibold mb-2">Today's Service Fees</h3>
          <p className="text-2xl font-bold text-indigo-600">₹18,750</p>
          <p className="text-gray-500 mt-1">Total fees collected today</p>
        </div>
      </div>
